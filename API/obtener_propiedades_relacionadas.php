...
require_once 'clases/entidades_api/api.inmuebles.php'; // Asegúrate de incluir la clase de API correcta
...
$app->get('/', \API_Inmuebles::class . ':ObtenerPropiedadesRelacionadas' );
