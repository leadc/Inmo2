...
class Calculation
{
     ...
     * @var string
     */
    private static $localeLanguage = 'es_ES'; //    US English    (default locale)
            ...
            if (isset(self::$binaryOperators[$token])) {
                ...
                switch ($token) {
                    ...
                    case '&':            //    Concatenation
                        ...
                        $this->debug->writeDebugLog('Evaluation Result is ', $this->showTypeDetails($result));
